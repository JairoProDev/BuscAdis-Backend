...
export class CreateInitialSchema1711123456789 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        // Add foreign key for publications to users
        await queryRunner.query(`
            ALTER TABLE "publications" 
            ADD CONSTRAINT "FK_publications_seller" 
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "publications" DROP CONSTRAINT "FK_publications_seller"`);
