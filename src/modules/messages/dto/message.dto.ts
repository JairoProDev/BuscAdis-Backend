...
import { PublicationResponseDto } from '../../publications/dto/publication.dto';
...
export class CreateMessageDto {
  ...
  @ApiProperty({
    description: 'The ID of the publication the message is about',
    example: '123e4567-e89b-12d3-a456-426614174000',
  })
  @IsUUID()
  @IsNotEmpty() // Add IsNotEmpty
  ...
  @ApiProperty({
    ...
    example: 'Hello, I am interested in your publication. Is it still available?',
    maxLength: 2000,
  })
  @IsString()
  @IsNotEmpty()
...
export class MessageResponseDto {
  ...
  @ApiProperty({
    description: 'The publication the message is about',
    type: () => PublicationResponseDto,
  })
  publication: PublicationResponseDto; // Correct: uses PublicationResponseDto
